...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  chromaKey: (red, green, blue, threshold, applyDespill, backgroundPath) => ipcRenderer.invoke('keyer:chromaKey', red, green, blue, threshold, applyDespill, backgroundPath),
